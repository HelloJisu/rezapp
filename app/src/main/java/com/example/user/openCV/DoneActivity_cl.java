...
public class DoneActivity_cl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finish = findViewById(R.id.cancle_cl);
        ...
        View.OnClickListener onClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()) {
                    case R.id.yes_ul:
                        intent = new Intent(getApplicationContext(), TreatActivity_cheekright.class);
